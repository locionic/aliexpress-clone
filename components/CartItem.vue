  ...
  <div class="flex justify-start my-2">
    <div class="my-auto">
      ...
      >
        ...
        >
          <div
            class="h-[8px] w-[8px] rounded-full bg-white"
          >
    ...
    <img :src="product.url" alt="Product Image" class="rounded-md md:w-[150px] w-[90px]">
    <div
      class="overflow-hidden pl-2 w-full"

    >
      <div class="flex items-center justify-between w-full">
        <div class="truncate flex items-center justify-between">
          <span class="sm:block hidden bg-[#FD374F] text-white text-[9px]"></span>
      ...
      <p
        class="text-[#009A66] text-xs font-semibold pt-1"
      >
