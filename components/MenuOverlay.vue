    ...
    <div class="flex items-center justify-between pt-5">
      <ul class="w-full">
        ...
        <li @click="goTo('shoppingcart')" class="relative flex items-center justify-between py-2 5 border-b px-3 hover:bg-gray-100 cursor-pointer">
          ...
          <div class="bg-[#FF4646] h-[35px] min-w-[35px] flex items-center justify-center tet-lg text-white rounded-full">
        ...
        <li v-else @click="signOut" class="relative flex items-center justify-between py-2 5 border-b px-3 hover:bg-gray-100 cursor-pointer">
          <div class="flex items-center text-[20px] font-semibold">
