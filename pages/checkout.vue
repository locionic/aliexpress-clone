    ...
    <div id="CheckoutPage" class="mt-4 max-w-[1200px] mx-auto px2">
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        <div class="md:w-[65%]">
          ...
          <div class="bg-white rounded-lg p-4 mt-4" id="Items">
        ...
        <div class=" md:w-[35%]">
          ...
          <form @submit.prevent="pay">
            ...
            <p class="text-red-700 text-center font-semibold" id="card-error" role="alert">
...
let stripe, elements, card, form, clientSecret = null
let total = ref(0)
